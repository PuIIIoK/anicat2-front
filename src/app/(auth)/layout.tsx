...
export default function RootLayout({ children }: LayoutProps) {
    return (
        ...
        <head>
            ...
            <meta
                name="description"
                content="Yumeko — смотри аниме, находи друзей, комментируй, ставь оценки и отзывы. У нас есть огромная библиотека 2K и 4K аниме. Зарегистрируйся и смотри с удовольствием!"
            />
            <meta property="og:title" content="Yumeko - твой аниме сайт!" />
            <meta
