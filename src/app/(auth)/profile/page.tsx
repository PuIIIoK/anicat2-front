...
const ProfilePage = () => {
    ...
    const fetchProfile = async () => {
        try {
            const response = await fetch('http://localhost:8080/api/auth/get-profile', {
                headers: {
    ...
    const fetchImages = async () => {
        try {
            ...
            const avatarRes = await fetch('http://localhost:8080/api/profile/get-cover-lk', {
            ...
            const bannerRes = await fetch('http://localhost:8080/api/profile/get-banner-lk', {
                headers: { Authorization: `Bearer ${token}` }
            });
            if (bannerRes.ok) {
