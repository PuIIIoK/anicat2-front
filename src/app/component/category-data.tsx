...
export const fetchAllCategories = async (): Promise<Category[]> => {
    try {
        const response = await fetch('http://localhost:8080/api/anime/category/get-category');
...
export const fetchCategoryById = async (categoryId: string): Promise<Category | null> => {
    try {
        const response = await fetch(`http://localhost:8080/api/anime/category/get-category/${categoryId}`);
